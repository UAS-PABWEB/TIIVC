    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Tambah Utang Pelanggan</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{ route('customer.store_debt', $customer->id) }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Nominal utang"
                            name="nominal" value="{{ old('nominal') }}" min="100" required autofocus>
                        @error('nominal')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input"
                                data-target="#reservationdate" name="tanggal" required />
